...
namespace Restaurant
{
    public class SummaryModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            {
                cartList.MenuItem = _unitOfWork.MenuItem.GetFirstOrderDefault(m => m.Id == cartList.MenuItemId);
                detailCart.OrderHeader.OrderTotal += (cartList.MenuItem.Price * cartList.Count);
            }

            ApplicationUser applicationUser = _unitOfWork.ApplicationUser.GetFirstOrderDefault(c => c.Id == claim.Value);
